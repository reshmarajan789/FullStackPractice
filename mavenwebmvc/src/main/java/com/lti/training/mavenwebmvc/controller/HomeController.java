...
public class HomeController {
  ...
  @GetMapping("/student") public String studentData(Model model){ { Student
 student=new Student("Reshma","arreshmarajan@gamil.com");
  model.addAttribute("student",student) ; return "Student-view"; }
